...
const config = {
    headers: {
        Authorization: `Bearer CHASECK_TEST-ojV2R5c5AaIAHrISuy8s28TY6vwEbtXt`
    }
};
...
async function performPaymentWithRetry(data, res) {
    ...
    if (!success) {
        ...
        pool.query('INSERT INTO payments (tx_ref, status) VALUES ("", "successful")');
    }
}
...
app.post("/api/pay", async (req, res) => {
    const TEXT_REF = "chewatatest-6669" + Date.now();
